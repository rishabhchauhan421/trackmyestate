...
/** Shared by `DropdownItem` and any custom menu row (e.g. a sign-out `<form>` button) that needs identical spacing/hover styling but can't go through `DropdownItem` itself (it hardcodes `type="button"`, which a submitting button can't use). */
...
export function DropdownItem({
  ...
  const classes = dropdownItemClassName(className);
